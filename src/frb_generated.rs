...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1383798167;
...
fn wire__crate__logger__SendToDartLogger_auto_accessor_get_level_impl(
...
fn wire__crate__logger__SendToDartLogger_auto_accessor_set_level_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
...
fn wire__crate__logger__SendToDartLogger_set_stream_sink_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::logger::SendToDartLogger::set_stream_sink(api_stream_sink);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__utils__available_value_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok =
                            crate::utils::available_value(&api_inputs, api_target_feerate)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
fn wire__crate__logger__create_log_stream_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::logger::create_log_stream(api_s)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
fn wire__crate__logger__set_up_rust_logger_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::logger::set_up_rust_logger();
                    })?;
                    Ok(output_ok)
                })())
            }
...
impl SseDecode for crate::logger::Level {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <i32>::sse_decode(deserializer);
        return match inner {
            0 => crate::logger::Level::Error,
            1 => crate::logger::Level::Warn,
            2 => crate::logger::Level::Info,
            3 => crate::logger::Level::Debug,
            4 => crate::logger::Level::Trace,
...
impl SseDecode for crate::logger::LogEntry {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_level = <crate::logger::Level>::sse_decode(deserializer);
...
impl SseDecode for crate::types::SelectionError {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return match inner {
            ...
            9 => crate::types::SelectionError::LongTermFeeRateMissing,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire__crate__logger__SendToDartLogger_set_stream_sink_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__crate__utils__available_value_impl(port, ptr, rust_vec_len, data_len),
        5 => {
            wire__crate__utils__calculate_accumulated_weight_impl(port, ptr, rust_vec_len, data_len)
        }
        6 => wire__crate__utils__calculate_base_weight_btc_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__utils__calculate_fee_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__utils__calculate_waste_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__algorithms__coin_grinder__coin_grinder_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__crate__types__coin_selection_opt_change_left_from_effective_value_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        12 => wire__crate__logger__create_log_stream_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__types__excess_strategy_default_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__logger__init_logger_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__types__output_group_default_impl(port, ptr, rust_vec_len, data_len),
        16 => {
            wire__crate__types__output_group_effective_value_impl(port, ptr, rust_vec_len, data_len)
        }
        17 => wire__crate__types__output_group_new_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__selectcoin__select_coin_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__algorithms__bnb__select_coin_bnb_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__algorithms__leastchange__select_coin_bnb_leastchange_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        22 => wire__crate__algorithms__knapsack__select_coin_knapsack_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        23 => wire__crate__algorithms__lowestlarger__select_coin_lowestlarger_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__algorithms__srd__select_coin_srd_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__logger__set_up_rust_logger_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__logger__SendToDartLogger_auto_accessor_get_level_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__logger__SendToDartLogger_auto_accessor_set_level_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for FrbWrapper<crate::logger::Level> {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self.0 {
            crate::logger::Level::Error => 0.into_dart(),
            crate::logger::Level::Warn => 1.into_dart(),
            crate::logger::Level::Info => 2.into_dart(),
            crate::logger::Level::Debug => 3.into_dart(),
            crate::logger::Level::Trace => 4.into_dart(),
            _ => unreachable!(),
        }
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for FrbWrapper<crate::logger::Level>
{
}
impl flutter_rust_bridge::IntoIntoDart<FrbWrapper<crate::logger::Level>> for crate::logger::Level {
    fn into_into_dart(self) -> FrbWrapper<crate::logger::Level> {
        self.into()
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl flutter_rust_bridge::IntoDart for crate::types::SelectionError {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            Self::LongTermFeeRateMissing => 9.into_dart(),
            _ => unreachable!(),
        }
    }
}
...
impl SseEncode for crate::types::CoinSelectionOpt {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <u64>::sse_encode(self.max_value, serializer);
...
impl SseEncode for crate::logger::Level {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                crate::logger::Level::Error => 0,
                crate::logger::Level::Warn => 1,
                crate::logger::Level::Info => 2,
                crate::logger::Level::Debug => 3,
                crate::logger::Level::Trace => 4,
                _ => {
                    unimplemented!("");
                }
            },
...
impl SseEncode for crate::logger::LogEntry {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <crate::logger::Level>::sse_encode(self.level, serializer);
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                ...
                crate::types::SelectionError::LongTermFeeRateMissing => 9,
                _ => {
                    unimplemented!("");
                }
            },
...
mod io {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_coinselect_flutter_ffi_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLevelFilter(
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_coinselect_flutter_ffi_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerLevelFilter(
        ptr: *const std::ffi::c_void,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_coinselect_flutter_ffi_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSendToDartLogger(
        ptr: *const std::ffi::c_void,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_coinselect_flutter_ffi_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSendToDartLogger(
        ptr: *const std::ffi::c_void,
    ) {
