...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1367582125;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__algorithms__knapsack__select_coin_knapsack_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__crate__algorithms__lowestlarger__select_coin_lowestlarger_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__crate__algorithms__srd__select_coin_srd_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
